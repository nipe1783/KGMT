#include "cpu/planners/PDST_6DI.h"
...
ob::StateSpacePtr PDST_6DI::createStateSpace() {
...
oc::ControlSpacePtr PDST_6DI::createControlSpace(ob::StateSpacePtr &space) {
...
oc::SimpleSetupPtr PDST_6DI::kinodynamicSimpleSetUp(const float* initial, const float* goal)
{
...
void PDST_6DI::plan(const float* initial, const float* goal, float* obstacles, int numObstacles, float safetyMargin) {
...
PDST_6DI::PDST_6DI() : boundsPos_(DIM/2), boundsVel_(DIM/2){};
PDST_6DI::~PDST_6DI(){};
